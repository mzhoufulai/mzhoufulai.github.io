...
{{< admonition >}}
这篇文章转载于[Dillon](https://hugoloveit.com/zh-cn/basic-markdown-syntax/)关于Markdown语法的文章。
{{< /admonition >}}
## 1 标题
...
## 相关文章
[1] Aaron Swartz的博客：(http://www.aaronsw.com/)   
[2] John Gruber的博客： (https://daringfireball.net/)   
